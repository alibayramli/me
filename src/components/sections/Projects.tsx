      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-12 max-w-3xl">
          ...
          <h2 className="mb-4 text-3xl font-bold md:text-4xl">
            Selected work that shows scope, delivery, and range
          </h2>
          <p className="max-w-2xl text-muted-foreground">
            Examples from internal platforms, workflow-heavy products, automation, and
            platform-enabled delivery work.
          </p>
        </div>
